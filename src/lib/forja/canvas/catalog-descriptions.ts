...
const WHAT_AND_WHY: Record<ComponentType, string> = {
  ...
  'ai-model': 'Un modelo de IA que el sistema consulta. Casi siempre es externo, con un costo y un riesgo de datos propios.',
  ...
  stream: 'Un registro de eventos que queda escrito y se puede volver a leer, no mensajes que se consumen una vez. Pensado para que varios lectores recorran el mismo historial, cada uno a su ritmo.',
