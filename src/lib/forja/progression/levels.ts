...
export interface LevelInfo {
  ...
  // It is the doc's own "Prerrequisito que lo habilita" column, used verbatim
  // in the locked-level message [PR1].
  enabledBy: string
}

export const LEVELS: LevelInfo[] = [
  { id: 1, name: 'Pensar antes de diseñar', prerequisiteLevel: null, enabledBy: 'el vocabulario del motor, todavía sin lienzo' },
  ...
  { id: 9, name: 'Seguridad, identidad y cumplimiento', prerequisiteLevel: 8, enabledBy: 'multi-tenencia: aislar es medio control de acceso' },
