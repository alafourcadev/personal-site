...
// level with no trap or counter-trap content (C2: the beta floor is 8 and
// trap pairs only enter at the 14-exercise "complete" tier) never requires one, because
